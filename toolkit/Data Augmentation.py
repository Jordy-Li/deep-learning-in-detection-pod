...
def change_xml_annotation(root, image_id, new_target):
    ...
    in_file = open(os.path.join(root, str(image_id) + '.xml'))  # 这里root分别两个意思
    tree = ET.parse(in_file)
...
def change_xml_list_annotation(root, image_id, new_target, saveroot, id):
    ...
    #修改xml中的path
    elem = tree.find('path')
    elem.text = (r'C:\Users\82678\Desktop\pod\\' + str(id) + '.jpg')
    xmlroot = tree.getroot()
...
if __name__ == "__main__":
    ...
    seq = iaa.Sequential([
        ...
        iaa.GaussianBlur(sigma=(0, 3.0)),  # iaa.GaussianBlur(0.5),高斯
        iaa.Affine(
